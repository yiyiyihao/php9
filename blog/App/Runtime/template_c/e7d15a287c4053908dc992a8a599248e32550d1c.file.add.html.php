<?php /* Smarty version Smarty-3.1.16, created on 2018-01-08 09:56:11
         compiled from ".\App\admin\View\category\add.html" */ ?>
<?php /*%%SmartyHeaderCode:185385a500e124f4460-75618930%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7d15a287c4053908dc992a8a599248e32550d1c' => 
    array (
      0 => '.\\App\\admin\\View\\category\\add.html',
      1 => 1515376568,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '185385a500e124f4460-75618930',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5a500e1251e768_65536970',
  'variables' => 
  array (
    'cate' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_5a500e1251e768_65536970')) {function content_5a500e1251e768_65536970($_smarty_tpl) {?><!DOCTYPE html>
<html lang="zh-cn">
<head>
      ...
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" action="index.php">
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="cname" name="cname" size="50" placeholder="类别名称" data-validate="required:请填写类别名称" />
            </div>
          </div>
          <div class="form-group">
            <div class="label">
...
<?php echo $_smarty_tpl->tpl_vars['v']->value['c_name'];?>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea class="input" name="cdesc" id="cdesc" rows="5" cols="50" placeholder="描述" data-validate="required:请填写分类描述"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="label">
            ...
            <div class="field">
              <input type="text" class="input" id="csort" name="csort" placeholder="50" size="50"  data-validate="required:请填写分类排序" />
            </div>
          </div>
