<?php /* Smarty version Smarty-3.1.16, created on 2018-01-30 19:25:50
         compiled from ".\App\Home\View\SinglePage\aboutme.html" */ ?>
<?php /*%%SmartyHeaderCode:31285a5419559e0157-47581630%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a7fb90f3f62dda5072e4ad7059a6cff1196dcdd2' => 
    array (
      0 => '.\\App\\Home\\View\\SinglePage\\aboutme.html',
      1 => 1517311548,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31285a5419559e0157-47581630',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5a541955a16b92_09876956',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a541955a16b92_09876956')) {function content_5a541955a16b92_09876956($_smarty_tpl) {?><!doctype html>
<html>
<head>
<meta charset="utf-8">
      ...
      $(function(){
        $("#aa").click(function(){
          ...
          num = layer.open({
            ...
            ,content: '用户名:<input type="text" name="username" value=""><br>密　码:<input type="password" name="password" value=""><br><input id="login" type="button" name="" value="登录">'
          });
          ...
          $("#login").click(function(){
            ...
            $.post('./login.php','',function(msg){
              ...
              layer.msg('登录成功');
              //显示用户欢迎语句,显示退出按钮
              $("#user").html("欢迎你"+msg.username+'<a href="#">退出</a>');
            },'json')
          });
        });
      })
...
<body>
<div class="ibody">
 <?php echo $_smarty_tpl->getSubTemplate ('../common/menu.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('active'=>4), 0);?>
  ...
  <aside>
    ...
    <div class="topspaceinfo">
      <h1><a  id= 'aa' href="">年终玩游戏，抽大奖</a></h1>
      <h2>感谢各位员工一年来对公司得贡献，祝大家新年快乐，阖家辛福，2018发大财。</h2> 
<!--       <h1>执子之手，与子偕老</h1>
